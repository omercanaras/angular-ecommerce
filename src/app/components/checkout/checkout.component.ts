...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //poplulate credit card months

    const startMonth:number=new Date().getMonth() + 1 ;
    console.log("starthMonth: " + startMonth);

    this.formService.getCreditCardMonths(startMonth).subscribe(
      data => {
        console.log("Retrieved credit card months:" + JSON.stringify(data));
        this.creditCardMonts=data;
      }
    );
    ...
    this.formService.getCreditCardYears().subscribe(
      data => {
        console.log("Restrieved credit card years: " + JSON.stringify(data) );
  ...
  reviewCartDetails() {
    ...
    //subscribr to cartService.totalQuantity
...
copyShippingAddressToBillingAddress(event:any){
  ...
  handleMonthsAndYears() {
    ...
    if(currentYear===selectedYear)
      ...
      this.formService.getCreditCardMonths(starthMonth).subscribe(
        data => {
          console.log("Retrieved credit card Months" + JSON.stringify(data));
          this.creditCardMonts=data;
        }
